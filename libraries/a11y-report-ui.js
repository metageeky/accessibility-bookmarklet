...
function createReportUI(report) {
	...
	var containerStyle = "position: fixed; top: 10px; right: 10px; max-height: 100%; min-width: 320px; max-width: 450px; z-index: 1000001;";
	...
	var iframeStyle = 'box-shadow: 10px 10px 10px 0px rgba(40,73,0,0.4); width: 100%; height:100%; border-width: 0;';
